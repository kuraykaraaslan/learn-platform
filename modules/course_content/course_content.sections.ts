...
export const COURSE_SECTIONS = [
  ...
  },
  {
    ...
    slugs: ['bim-ifc-data-models', 'gis-spatial-data', 'autodesk-developer-platform', 'model-coordination-exchange', 'iot-hardware-basics', 'embedded-firmware', 'iot-telemetry-edge', 'digital-twin-engineering', 'field-data-collection', 'asset-management-systems', 'smart-infrastructure'],
  },
